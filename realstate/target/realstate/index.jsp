      ...
      <section class="flex">
         ...
         <div class="menu">
            <ul>
               ...
               <li><a href="#">Ayuda<i class="fas fa-angle-down"></i></a>
                  <ul>
                     <li><a href="resources/about.jsp">Acerca de Nosotros</a></li>
                     <li><a href="resources/contact.jsp">Contactanos</a></li>
                     <li><a href="resources/contact.jsp#faq">FAQ</a></li>
                  </ul>
               </li>
            </ul>
         </div>
         ...
         <ul>
            <li><a href="#">Cuenta<i class="fas fa-angle-down"></i></a>
               <ul>
                  <li><a href="resources/login.jsp">Ingresar</a></li>
               </ul>
            </li>
         </ul>
      </section>
...
<div class="home">
   ...
   <section class="center">
      ...
      <form action="resources/search.html" method="post">
         ...
         <a href="resources/login.jsp" class="btn">Buscar Propiedad</a>
      </form>
...
<section class="listings">
   ...
   <div style="margin-top: 2rem; text-align:center;">
      <a href="resources/listings.jsp" class="inline-btn">Ver Todo</a>
   </div>
...
<footer class="footer">
   ...
   <section class="flex">
      ...
      <div class="box">
         ...
         <a href="resources/about.jsp"><span>Acerca de Nosotros</span></a>
         <a href="resources/contact.jsp"><span>Contactenos</span></a>
         <a href="resources/listings.jsp"><span>Todas las Propiedades</span></a>
      </div>
