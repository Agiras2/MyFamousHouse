...
public class HomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (properties != null) {
            System.out.println("HomeServlet - Number of properties retrieved: " + properties.size());
        } else {
            System.out.println("HomeServlet - No properties retrieved.");
        }
        ...
        request.getRequestDispatcher("/resources/home.jsp").forward(request, response);
    }
