...
<section class="listings">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="resources/UpdateProperty.jsp?enrollmentId=<%= property.getEnrollmentId() %>" class="btn">Actualizar</a>
            <!-- Formulario para borrar la propiedad con confirmación -->
            <form action="DeletePropertyServlet" method="post" onsubmit="return confirm('¿Está seguro de que desea eliminar esta propiedad?');">
